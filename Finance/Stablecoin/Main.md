...
- **Pegging**: The issuer holds reserve assets — cash, [U.S. Treasury bills](https://claude.ai/chat/treasury_bonds_guide.md), short-term repos, money market funds — that back each token at approximately 1:1 value. This reserve is what anchors the token's price to $1.
...
→ _See full four-layer stack breakdown: [Stablecoin AI Agent Payment Infrastructure — Complete Summary](https://claude.ai/chat/ai_agent_payment_infrastructure.md)_
