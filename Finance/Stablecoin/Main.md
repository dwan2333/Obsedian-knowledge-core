...
- **Pegging**: The issuer holds reserve assets — cash, [[treasury_bonds_guide|U.S. Treasury bills]], short-term repos, money market funds — that back each token at approximately 1:1 value. This reserve is what anchors the token's price to $1.
...
→ _See full four-layer stack breakdown: [[ai_agent_payment_infrastructure|Stablecoin AI Agent Payment Infrastructure — Complete Summary]]_
