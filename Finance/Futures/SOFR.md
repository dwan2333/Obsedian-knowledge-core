...
SOFR measures the cost of borrowing cash overnight through **repurchase agreements (repos)**, where borrowers put up [U.S. Treasury bonds](<../Treasury Bonds/treasury_bonds_guide.md>) as collateral. It replaced LIBOR, which was phased out after manipulation scandals.
...
3. Bank A hands over [U.S. Treasury bonds](<../Treasury Bonds/treasury_bonds_guide.md>) to Bank B as **collateral** — a security deposit.
...
### Why [Treasury Bonds](<../Treasury Bonds/treasury_bonds_guide.md>)?
...
| **[Treasury](<../Treasury Bonds/treasury_bonds_guide.md>) auction settlement** | Buyers drain cash to pay for new bonds | SOFR ticks up slightly |
...
- **SOFR** = the average cost of borrowing cash overnight, secured by [U.S. Treasury bonds](<../Treasury Bonds/treasury_bonds_guide.md>).
...
- **[Treasury Bonds — A Beginner's Guide](<../Treasury Bonds/treasury_bonds_guide.md>)** — The underlying collateral asset in every repo transaction that SOFR measures.
- **[Stablecoin Deep Dive](../Stablecoin/Main.md)** — Fiat-backed stablecoins hold U.S. Treasuries as reserves; SOFR reflects the overnight cost of borrowing against those same Treasuries.
