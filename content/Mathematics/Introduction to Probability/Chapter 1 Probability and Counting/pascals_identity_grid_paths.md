...
*Visual aid generated by Nano Banana Pro — example increasing path from $(0,0)$ to $(m,n)$.*
...
*Visual aid generated by Nano Banana Pro — the two ways to enter $(m,n)$.*
...
*Visual aid generated by Nano Banana Pro — two distinct paths from $(0,0)$ to $(3,2)$, both with 3 R's and 2 U's but in different orders.*
...
*Visual aid generated by Nano Banana Pro — the path-count grid rotates into Pascal's triangle, with the origin $(0,0)$ becoming the apex.*
...
*Visual aid generated by Nano Banana Pro — the entry $\binom{5}{2} = 10$ as the sum of $\binom{4}{1} = 4$ and $\binom{4}{2} = 6$ directly above.*
